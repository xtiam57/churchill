...
export const NOTICES = [
  {
    ...
    slides: [
      ...
      Slide.create({
        ...
        text: 'Cuando <strong>disfruta</strong> algo no desea <strong>interrupciones</strong>. La <strong>Palabra de Dios</strong> merece respeto.',
      }),
      Slide.create({
        title: '<span class="fs-xl">🤐</span>',
        text: '<strong>Evite conversar</strong> o hacer ruido durante el culto. Dios quiere hablarle.',
      }),
      Slide.create({
        title: '<span class="fs-xl">📱</span>',
        text: 'Por favor <strong>apague su celular</strong> y evite usarlo durante el culto. Vino a ver a Dios no a su celular.',
      }),
      Slide.create({
        title: '<span class="fs-xl">🍔</span>',
        text: 'Espere un poco más y <strong>no ingiera alimentos</strong> durante el culto.',
      }),
      Slide.create({
        title: '<span class="fs-xl">🪑🚶🪑</span>',
      ...
      Slide.create({
        title: '<span class="fs-xl">👦👶👧</span>',
        text: 'No deje que sus niños corran o jueguen durante el culto. <strong>Llévelos a su clase</strong>. Ellos también necesitan a Dios.',
      }),
      Slide.create({
        title: '<span class="fs-xl">🧻🧼🚽</span>',
      ...
      Slide.create({
        title: '<span class="fs-xl">⛪</span>',
        text: 'Recuerde <strong>cuidar la Iglesia y sus instalaciones</strong>. No olvide que es la Casa de Dios.',
      }),
    ],
  },
  {
  ...
  },
  {
    ...
    index: 4,
    type: 'notice',
    title: '¿Cómo guiar un alma a Dios?',
    slides: [
      Slide.create({
        title: '<span class="fs-xl">🎁</span>',
        text: '¿Cómo/n<strong class="fs-xl" style="line-height:1">GANAR ALMAS</strong>/npara Dios?',
      }),
      Slide.create({
        title: '<span class="fs-xl">🚧🛑🚧</span>',
        text: 'NUESTRA CONDICIÓN:/n<strong>El camino al cielo y a Dios está cerrado por el pecado</strong>',
      }),
      Slide.create({
        title: '<span class="fs-xl">⚖</span>',
      ...
      Slide.create({
        title: '<span class="fs-xl">🔥😈🔥</span>',
        text: 'LA CONSECUENCIA:/n<strong>El pecado nos lleva a otro destino</strong>',
      }),
      Slide.create({
        title: '<span class="fs-xl">☠</span>',
      ...
      Slide.create({
        title: '<span class="fs-xl">🚪</span>',
        text: 'LA SOLUCIÓN:/n<strong>Jesucristo es la puerta y el camino al cielo</strong>',
      }),
      Slide.create({
        title: '<span class="fs-xl">💖</span>',
      ...
      Slide.create({
        title: '<span class="fs-xl">✝</span>',
        text: 'LA SOLUCIÓN:/n<strong>Recibe a Jesús como tu Salvador</strong>',
      }),
      Slide.create({
        title: '<span class="fs-xl">👄❤</span>',
      ...
      Slide.create({
        title: '<span class="fs-xl">🙏</span>',
        text: '<b>HABLA CON DIOS Y DILE:</b>/nSeñor Jesús <b>reconozco</b> que te he fallado y que soy pecador, pero <b>te pido perdón</b> por todos mis pecados, <b>te acepto</b> como mi Salvador, <b>te recibo</b> en mi corazón y el día en que yo muera sé que voy a estar contigo en el cielo. Gracias por salvarme, en tu nombre, Amén.',
      }),
    ],
  },
  {
