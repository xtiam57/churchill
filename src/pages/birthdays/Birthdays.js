  ...
  return (
    <Wrapper>
      <Sidebar>
        ...
        <DisplayButton
          value={showLogo}
          presenting={presenting && birthdays?.length}
        ...
        {file ? (
          ...
          <div className="mb-4">
            ...
            />
            <div className="form-text text-muted fs-sm">
              <small className="mb-2 d-block">
                El archivo Excel debe tener las columnas "nombres" (texto),
                "dia" (1 al 31) y "mes" (1 al 12).
              </small>
            </div>
          </div>
        )}
