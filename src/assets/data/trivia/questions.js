export const questions = [
  ...
  },
  {
    ...
    question:
      '¿Quién dijo <i>"Muera yo ahora, ya que he visto tu rostro, y sé que aún vives"</i>?',
  ...
  },
  {
    difficulty: 'EASY',
    question:
      '¿Qué capítulo es considerado el <i>"Salón de la fama de la fe"</i>?',
  ...
  },
  {
    difficulty: 'EASY',
    question:
      '¿Quién es considerado en la Biblia <i>"El hombre más manso"</i>?',
  ...
  },
  {
    difficulty: 'MEDIUM',
    question:
      '¿Quién dijo <i>"Señor, no tienes con qué sacarla, y el pozo es hondo. ¿de dónde, pues, tienes el agua viva?"</i>?',
    options: [
      'Mujer samaritana',
      'Viuda de Sarepta',
      'Mujer adultera',
  ...
  },
  {
    difficulty: 'EASY',
    question:
      '¿Quién dijo <i>"¿Quién es Jehová, para que yo oiga su voz y deje ir a Israel? Yo no conozco a Jehová, ni tampoco dejaré ir a Israel"</i>?',
  ...
  {
    difficulty: 'HARD',
    question: '¿Quién dijo <i>"Por voluntad de Jehová he adquirido varón"</i>?',
  ...
  },
  {
    difficulty: 'EASY',
    question:
      '¿A quién se refieren las siguientes pistas: <i>"carne, sueño, mujer, huesos, costilla"</i>?',
  ...
  },
  {
    difficulty: 'VERY_HARD',
    question:
      '¿Quién dijo <i>"Mi corazón se regocija en Jehová, Mi poder se exalta en Jehová; Mi boca se ensanchó sobre mis enemigos, Por cuanto me alegré en tu salvación"</i>?',
  ...
  },
  {
    difficulty: 'EASY',
    question:
      '¿Quién condujo a los israelitas a conquistar la <i>"Tierra Prometida"</i>?',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      '¿A qué ciudad se refirió Jesús cuando dijo <i>"No hay profeta sin honra, sino en su propia tierra y en su casa"</i>?',
  ...
  },
  {
    difficulty: 'MEDIUM',
    question:
      '¿Qué parábola relató Jesús para responder a la pregunta <i>"¿Quién es mi prójimo?"</i>?',
    options: [
      'El buen samaritano',
      'El hijo pródigo',
      'La oveja perdida',
  ...
  },
  {
    difficulty: 'VERY_HARD',
    question:
      '¿Quién dijo <i>"No temáis; estad firmes, y ved la salvación que Jehová hará hoy con vosotros"</i>?',
  ...
  },
  {
    difficulty: 'VERY_HARD',
    question:
      '¿En qué libro se encuentra la siguiente frase <i>"y me buscaréis y me hallaréis, porque me buscaréis de todo vuestro corazón"</i>?',
  ...
  {
    difficulty: 'VERY_HARD',
    question: '¿Quién fue llamado el <i>"Tisbita"</i>?',
  ...
  },
  {
    difficulty: 'MEDIUM',
    question:
      '¿En qué libro aparece la cita: <i>"Dios es nuestro amparo y fortaleza, nuestro pronto auxilio en las tribulaciones"</i>?',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      'Jesús dijo <i>"cuando veáis en el lugar santo la abominación desoladora de que habló el profeta Daniel entonces los que estén en Judea..."</i>',
    options: [
      'Huyan a los montes',
      'Huyan a los campos',
      'Clamen al Padre',
  ...
  {
    difficulty: 'MEDIUM',
    question: '¿Quién dijo <i>"Nunca os conocí"</i>?',
  ...
  {
    difficulty: 'MEDIUM',
    question: '¿Quién dijo: <i>"¿De Nazaret puede salir algo de bueno?"</i>?',
  ...
  {
    difficulty: 'MEDIUM',
    question: '¿Quién dijo <i>"Yo sé que mi Redentor vive"</i>?',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      '¿A quién dijo Jesús: <i>"Ve al mar, y echa el anzuelo, y el primer pez que saques, tómalo, y al abrirle la boca, hallarás un estatero"</i>?',
  ...
  {
    difficulty: 'MEDIUM_EASY',
    question: '¿Quién es el <i>"Padre de la Fe"</i>?',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      '¿A quién se refiere Isaías con <i>"Voz que clama en el desierto: Preparad camino a Jehová"</i>?',
  ...
  },
  {
    difficulty: 'MEDIUM_EASY',
    question:
      '¿Quién dijo <i>"Señor, si hubieses estado aquí, mi hermano no habría muerto"</i>?',
  ...
  {
    difficulty: 'HARD',
    question: '¿Cómo se traduce <i>"Emanuel"</i>?',
    options: [
      'Dios con nosotros',
      'Dios nuestro',
      'Bendito de Dios',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      '¿Quién dijo <i>"¿Soy yo perro, para que vengas a mí con palos?"</i>?',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      '¿Quién dijo <i>"¿quién podrá gobernar este tu pueblo tan grande?"</i>?',
  ...
  },
  {
    difficulty: 'MEDIUM',
    question:
      '¿Quién dijo <i>"He aquí el fuego y la leña; mas ¿dónde está el cordero para el holocausto?"</i>?',
  ...
  },
  {
    difficulty: 'VERY_HARD',
    question:
      '¿Quién dijo <i>"Ordena que en tu reino se sienten estos dos hijos míos, el uno a tu derecha, y el otro a tu izquierda"</i>?',
    options: [
      'La mujer de Zebedeo',
      'La mujer de Felipe',
      'La mujer de Zaqueo',
  ...
  {
    difficulty: 'MEDIUM_EASY',
    question: '¿Quién dijo <i>"Si perezco, que perezca"</i>?',
  ...
  },
  {
    difficulty: 'HARD',
    question:
      '¿En qué capítulo se encuentra <i>"Satanás atado por mil años"</i>?',
    options: [
      'Apocalipsis 20',
      'Apocalipsis 21',
      'Apocalipsis 19',
  ...
  {
    difficulty: 'HARD',
    question: '¿En qué capítulo se encuentra <i>"El Sermón del monte"</i>?',
  ...
  },
  {
    difficulty: 'EASY',
    question:
      '<i>"********** es a mis pies tu palabra,/nY lumbrera a mi camino"</i>',
    options: ['Lámpara', 'Faro', 'Luz', 'Linterna'],
    reference: 'Salmos 119:105',
  },
  {
    difficulty: 'MEDIUM_EASY',
    question: 'Su comida era langostas y miel silvestre',
    options: ['Juan el Bautista', 'Simón Pedro', 'Elías', 'Eliseo'],
    reference: 'Mateo 3:4',
  },
  {
    difficulty: 'EASY',
    question: 'Está numerado y compuesto por varios versículos',
    options: ['Un capítulo', 'Un libro', 'La Biblia', 'Un poema'],
    reference: '',
  },
  {
    difficulty: 'EASY',
  ...
  {
    difficulty: 'EASY',
    question: 'El <i>"pata"</i> de David era:',
    options: ['Jonatán', 'Urías', 'Natán', 'Saúl'],
